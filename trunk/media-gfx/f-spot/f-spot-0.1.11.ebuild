...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/f-spot/f-spot-0.1.11.ebuild,v 1.1 2006/06/03 18:29:26 joem Exp $
...
src_unpack()
{
	...
	epatch ${FILESDIR}/${P}-localtime.patch
	epatch ${FILESDIR}/${P}-timediff.patch
