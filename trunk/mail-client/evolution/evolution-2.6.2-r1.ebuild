...
# $Header: /var/cvsroot/gentoo-x86/mail-client/evolution/evolution-2.6.2-r1.ebuild,v 1.1 2006/07/01 20:38:51 dang Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/${P}-mailicon.patch
...
src_install() {
	...
	insinto /usr/share/${PN}/2.6/images
	doins ${FILESDIR}/*.png
}
