...
src_unpack() {
	...
	java-pkg_jar-from glib-java-0.2
	java-pkg_jar-from libgtk-java-2.8
	java-pkg_jar-from libgconf-java-2.12
	java-pkg_jar-from libgnome-java-2.12
	java-pkg_jar-from libglade-java-2.12
	java-pkg_jar-from cairo-java-1.0
	java-pkg_jar-from libvte-java-0.12
}
